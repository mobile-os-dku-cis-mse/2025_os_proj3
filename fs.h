...
#define INODE_MODE_REG_FILE		0x10000 // 일반 파일
#define INODE_MODE_DIR_FILE		0x20000 // 디렉토리 파일
#define INODE_MODE_DEV_FILE		0x40000 // 디바이스 파일

#define DENTRY_TYPE_REG_FILE	0x1
#define DENTRY_TYPE_DIR_FILE	0x0
